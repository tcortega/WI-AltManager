...
import net.wurstclient.altmanager.libs.*;
import net.wurstclient.altmanager.util.ListWidget;
import net.wurstclient.altmanager.util.MultiProcessingUtils;
    ...
    private void pressImportAlts()
    {
        try
        {
            Process process = MultiProcessingUtils.startProcessWithIO(
                    ...
                    WiAltManager.INSTANCE.getAltManagerFolder().toString());
